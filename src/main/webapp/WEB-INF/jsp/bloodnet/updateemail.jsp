...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="card card-info">
    	<form action="/shristationery/client/client-email-id-update" method="post" class="form-horizontal" >
    		<div class="input-group mb-3">
				<input type="text" class="form-control" name="aadhar_number" id="aadhar_number" placeholder="Enter aadhar number" required>
            </div>
    		<div class="input-group mb-3">
